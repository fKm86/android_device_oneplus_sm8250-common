...
PRODUCT_COPY_FILES += \
    ...
    vendor/scorpion/prebuilt/common/etc/vendor.lineage.biometrics.fingerprint.inscreen.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/permissions/vendor.lineage.biometrics.fingerprint.inscreen.xml
